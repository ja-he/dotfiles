...
\section{Examples}
    ...
    \todo{Example TODO Note with some content in it, simply to showcase that
        now these notes can contain some text without it being likely for you
        to run into spacing troubles, due to the margins}
